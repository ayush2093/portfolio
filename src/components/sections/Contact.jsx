...
const Contact = () => {
  const contactInfo = [
    {
      ...
      label: "Email",
      value: "ayushsingh2093@gmail.com",
      link: "mailto:ayushsingh2093@gmail.com",
    },
    {
    ...
    },
    {
      ...
      label: "Twitter",
      value: "AyushSi70063997",
      link: "https://x.com/AyushSi70063997",
    },
  ];
  ...
  const socialLinks = [
    {
      ...
      label: "GitHub",
      link: "https://github.com/ayush2093",
    },
    {
      icon: <Linkedin className="w-5 h-5" />,
      label: "LinkedIn",
      link: "https://www.linkedin.com/in/ayush-singh-622951297/",
    },
  ];
  ...
  const sendMailFallback = () => {
    const emailAddr = "ayushsingh2093@gmail.com";
    ...
    if (navigator.clipboard) {
      navigator.clipboard.writeText(emailAddr)
        .then(() => {
          sonnerToast.success("Email copied to clipboard!");
        })
        .catch(() => {});
    }
    ...
    <section id="contact" className="contact-section">
            ...
            <div className="contact-grid">
                ...
                {contactInfo.map((info, index) => (
                  <div key={index} className="info-item">
                    ...
                    <div className="info-content">
                      ...
                      {info.link ? (
                        <a href={info.link} className="info-value link-value">
                          {info.value}
                        </a>
                      ) : (
              ...
              <div className="contact-form">
                ...
                <div className="form-fields">
                  ...
                  <Button className="submit-button" onClick={sendMail} disabled={loading}>
                    {loading ? (
      ...
      <style jsx>{`
        ...
        .form-textarea:focus {
          ...
          box-shadow: 0 0 0 4px hsl(var(--primary) / 0.1), 0 0 20px hsl(var(--primary) / 0.1);
        ...
        .submit-button:hover:not(:disabled) {
          transform: translateY(-2px);
          box-shadow: 0 12px 32px hsl(var(--primary) / 0.3), 0 0 0 1px hsl(var(--primary) / 0.1);
          opacity: 0.95;
        }
